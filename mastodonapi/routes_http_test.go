...
func TestMastodonRoutes_publicAndUnauthorized(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "v2 filters 401", method: http.MethodGet, path: "/api/v2/filters", wantCode: http.StatusUnauthorized},
		...
		{name: "timeline list 401", method: http.MethodGet, path: "/api/v1/timelines/list/1", wantCode: http.StatusUnauthorized},
		...
		{name: "conversations list 401", method: http.MethodGet, path: "/api/v1/conversations", wantCode: http.StatusUnauthorized},
