...
func (s *Server) mountMastodon(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/v1/statuses/{id}/favourited_by", s.v1StubGETEmptyArray)
	mux.HandleFunc("GET /api/v1/statuses/{id}/reblogged_by", s.v1StubGETEmptyArray)
	mux.HandleFunc("POST /api/v1/statuses/{id}/favourite", b(s.postStatusActionNotFound))
	mux.HandleFunc("POST /api/v1/statuses/{id}/unfavourite", b(s.postStatusActionNotFound))
	mux.HandleFunc("POST /api/v1/statuses/{id}/reblog", b(s.postStatusActionNotFound))
	mux.HandleFunc("POST /api/v1/statuses/{id}/unreblog", b(s.postStatusActionNotFound))
	mux.HandleFunc("POST /api/v1/statuses/{id}/bookmark", b(s.v1StubBearerEmptyObject))
	mux.HandleFunc("POST /api/v1/statuses/{id}/unbookmark", b(s.v1StubBearerEmptyObject))
	...
	mux.HandleFunc("GET /api/v1/favourites", b(s.v1StubBearerEmptyArray))
	mux.HandleFunc("GET /api/v1/bookmarks", b(s.v1StubBearerEmptyArray))
